...
import Badge from "../src/components/caseStudy/Badge";
import GrayBox from "../src/components/caseStudy/GrayBox";
import ProConCard from "../src/components/caseStudy/ProConCard";
import Hatching from "../src/components/Hatching";
                ...
                <div className="relative z-10 mx-auto flex w-full bg-bg-subtle max-w-[1024px] flex-col gap-8 px-4 pb-32">
                    ...
                    <section className="flex flex-col border-x border-t border-border-default w-full">
                        <div className="flex flex-col px-6 py-8 gap-6 w-full text-left">
                            <Heading>YouTube Case Study — Building...</Heading>
                            <BodyText>
                                I am currently refactoring this case study to match the new standardized layout. Check back soon for the updated deep dive into intent-based search!
                            </BodyText>
                        </div>
                    </section>
