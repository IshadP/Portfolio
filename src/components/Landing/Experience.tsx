...
export default function Experience() {
  return (
    <section className="w-full max-w-5xl mx-auto p-6 bg-bg-subtle border border-border-default flex flex-col md:flex-row justify-start items-start">
          ...
          <React.Fragment key={index}>
            <div className="self-stretch flex flex-col md:flex-row justify-between items-start gap-1 md:gap-4">
              <div className="flex-1 flex flex-col justify-start items-start gap-1">
                <h3 className="font-body-lg-bold text-text-primary leading-tight">
                  {exp.title}
                </h3>
                <p className="font-label-md text-text-muted">{exp.company}</p>
              </div>
              <div className="shrink-0 pt-1">
                <span className="font-label-md-mono text-text-muted whitespace-nowrap leading-7">
                  {exp.date}
                </span>
              </div>
            </div>
