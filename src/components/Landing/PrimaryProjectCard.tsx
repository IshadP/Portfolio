...
export default function PrimaryProjectCard({
  ...
  const contentBox = (
    <div className="self-stretch flex flex-col justify-start items-start gap-4">
      ...
      >
        <motion.div
          transition={spring}
          className="self-stretch w-full p-2 bg-blue-800 rounded-xs inline-flex justify-center items-center gap-2 overflow-hidden"
        >
  ...
  return (
    <Wrapper
      ...
      whileTap="tap"
      animate="rest"
      className={`w-full max-w-5xl flex flex-col md:grid md:grid-cols-3 md:h-[600px] rounded-lg border border-border-default overflow-hidden cursor-pointer ${className || ""}`}
    ...
    >
      ...
      <motion.div
        variants={dividerVariants}
        transition={spring}
        className="md:hidden w-full border-b border-border-default flex p-4"
      >
        {headerRow}
      </motion.div>
      ...
      <motion.div
        variants={dividerVariants}
        transition={spring}
        className="md:hidden w-full border-t border-border-default flex p-4 relative z-20"
      >
        {contentBox}
      </motion.div>
    </Wrapper>
