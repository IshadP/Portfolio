...
import { Check, CopySimpleIcon } from "@phosphor-icons/react";
...
export default function Footer() {
    ...
    return (
        <footer className="w-full flex flex-col items-center">
            ...
            <div className="w-full max-w-[1024px] h-fit bg-bg-subtle border border-border-default flex md:flex-row flex-col justify-between items-center rounded-bl-lg rounded-br-lg ">

                {/* Social Links */}
                <div className="flex w-full md:w-fit justify-start items-stretch border-border-default  rounded-bl-lg overflow-hidden">
                    {socialLinks.map((platform) => (
                        <a
                            ...
                            className={`group flex flex-1 md:flex-none md:w-16 h-16 aspect-square items-center justify-center border-r border-border-default no-underline ${platform.mobileClassName} md:bg-transparent ${platform.hoverClassName} transition-colors`}
                        >
                            <div
                                className="text-bg-default md:text-text-primary md:group-hover:text-bg-default transition-colors"
                            >
                                {platform.icon}
                            </div>
                        </a>
                ...
                <div className="hidden md:flex items-stretch">
                    <div className="self-stretch px-6 py-2 flex items-center gap-1">
                        ...
                        >
                            ...
                            {copied ? <Check size={20} weight="bold" /> : <CopySimpleIcon size={20} />}
                        </motion.button>
                    </div>
                </div>
